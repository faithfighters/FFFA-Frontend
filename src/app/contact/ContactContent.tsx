                ...
                <div className="container">
                    <div className={styles.grid}>
                        ...
                        <div>
                            ...
                            <h2 className={styles.sectionTitle}>Ways to connect</h2>

                            <div className={styles.infoGrid}>
                                <a href="mailto:info@faithfightersforamerica.com" className={styles.infoCard}>
                                    <div className={styles.infoIcon}><Mail size={20} /></div>
                                    <div>
                                        <h4>Email us</h4>
                                        <p>info@faithfightersforamerica.com</p>
                                    </div>
                                </a>
                                ...
                                <div className={styles.infoCard}>
                                    ...
                                    <div>
                                        <h4>Visit us</h4>
                                        <p>1751 Mound St, Suite 201 · Sarasota, FL 34236</p>
                                    </div>
                                </div>
                            </div>

                            <div className={styles.socials}>
                                <a href="https://www.youtube.com/@FaithFightersforAmerica" target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="YouTube">
                                ...
                                <a href="#" className={styles.socialLink} aria-label="X (coming soon)">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                <a href="#" className={styles.socialLink} aria-label="TikTok (coming soon)">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
