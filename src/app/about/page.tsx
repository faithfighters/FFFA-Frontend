...
export default function AboutPage() {
    return (
        <>
                ...
                <div className="container">
                    <div className={styles.twoColumn}>
                        <div className={styles.textCol}>
                            <span className="section-label section-label--red" style={{ color: 'rgba(255,255,255,0.55)' }}>About Us</span>
            ...
            <section className={`section ${styles.ourStory}`}>
                <div className="container">
                    <div className={styles.twoColumn}>
                        ...
                        <div className={styles.textCol}>
                            <span className="section-label section-label--red" style={{ color: 'rgba(255,255,255,0.55)' }}>Our Journey</span>
            ...
            {/* ===== HOW WE OPERATE ===== */}
            <section className={`section ${styles.howWeOperate}`}>
                <div className="container">
                    <span className="section-label section-label--red" style={{ color: 'rgba(255,255,255,0.55)' }}>Check Out</span>
            ...
            <section className={`section ${styles.leadership}`}>
                <div className="container">
                    <span className="section-label section-label--red" style={{ color: 'rgba(255,255,255,0.55)' }}>Leadership</span>
