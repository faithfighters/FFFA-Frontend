...
const steps = [
    {
        icon: <Sparkles size={40} color="#F8C38F" />,
    ...
    {
        icon: <Vote size={40} color="#F8C38F" />,
        title: 'You Have 30 Votes This Month',
        body: 'Your Faith Fighter membership gives you 30 donation votes per cycle. Use them anytime — your votes direct real money to the causes you care about most.',
        cta: 'Next',
    },
    {
        icon: <DollarSign size={40} color="#F8C38F" />,
            ...
            <div className={styles.card} data-animating={animating}>
                ...
                {step === 1 && (
                    <div className={styles.voteBox}>
                        ...
                        <div className={styles.voteSub}>use anytime this cycle</div>
                    </div>
                )}
