    ...
    if (loading) {
        return (
            <div className={styles.votePage}>
                <div className="container" style={{ textAlign: 'center', padding: 'var(--space-3xl)', color: 'rgba(255,255,255,0.6)' }}>
                ...
                <div className="container">
                    {submitted ? (
                        <div className={styles.successCard}>
                            <div className={styles.successIcon}><CheckCircle2 size={52} color="#F8C38F" /></div>
                        ...
                        <>
                            ...
                            {!cycle && (
                                <div style={{ background: 'rgba(248,195,143,0.08)', border: '1px solid rgba(248,195,143,0.25)', borderRadius: 8, padding: 'var(--space-lg)', marginBottom: 'var(--space-lg)', color: '#F8C38F', textAlign: 'center' }}>
