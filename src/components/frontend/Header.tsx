...
export default function Header() {
  ...
  const handleDonateClick = async (e: React.MouseEvent<HTMLAnchorElement>) => {
    // Navigation is handled by the href — no SSO redirect needed for user dashboard
    void e;
  };
  ...
  const isAuthPage = pathname === '/login' || pathname === '/register' || pathname === '/subscribe' || pathname === '/coming-soon';
