        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontWeight: 700, fontSize: '15px', color: '#0f172a' }}>
              ...
              {unreadCount > 0 && (
                <span style={{
                  marginLeft: '8px', background: '#fef2f2', color: '#dc2626',
            ...
            {unreadCount > 0 && (
              <button
                ...
                style={{
                  ...
                  fontSize: '12px', color: '#dc2626', fontWeight: 600, fontFamily: 'inherit',
          ...
          <div style={{ maxHeight: '400px', overflowY: 'auto' }}>
            {notifications.length === 0 ? (
              <div style={{ padding: '40px 20px', textAlign: 'center', color: '#94a3b8', fontSize: '14px' }}>
                <div style={{ marginBottom: '8px', display: 'flex', justifyContent: 'center' }}><Bell size={28} color="#94a3b8" /></div>
                ...
                const item = (
                  ...
                  >
                    <div style={{
                      ...
                      background: n.read ? 'transparent' : '#dc2626', marginTop: '6px',
                    }} />
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ fontSize: '11px', color: '#94a3b8' }}>{timeAgo(n.createdAt)}</div>
                    </div>
                  </div>
                );
