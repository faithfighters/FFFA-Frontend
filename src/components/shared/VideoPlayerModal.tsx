...
import { X, Play, Pause, Volume2, VolumeX, ThumbsUp, ChevronUp, ChevronDown, Flag, CheckCircle2, AlertCircle, Vote, Compass, Home, Activity, User, Flame, Menu, Zap } from 'lucide-react';
            ...
            >
                ...
                <div className="vpm-mobile-nav" onClick={e => e.stopPropagation()}>
                    {[
                        ...
                        {
                            label: 'Faith', href: '/dashboard/campaigns',
                            // eslint-disable-next-line @next/next/no-img-element
                            icon: <img src="/images/fffa file 1 (1).png" alt="" style={{ width: 20, height: 20, objectFit: 'contain' }} />,
                        },
                        { label: 'Leaderboard', href: '/dashboard/leaderboard', icon: <Activity size={20} /> },
                        { label: 'Profile', href: '/dashboard/profile', icon: <User size={20} /> },
                    ].map((item) => {
                        const isVote = item.label === 'Faith';
                        // While this reel view is open, "Faith" is the active tab exclusively —
